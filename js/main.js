document.addEventListener('DOMContentLoaded', () => {
  ...
  const gridsToAnimate = document.querySelectorAll('.news-grid, .card-grid, .info-cards-grid, .contact-grid, .donation-grid, .donation-options, .team-grid, .product-grid, .cake-grid, .values-grid, .impact-grid');
